...
from piezojet.projector import point_group_residual, project_piezo_to_point_group
...
def test_projector_is_idempotent_and_inversion_zeroes_polar_rank3():
    ...
    assert torch.allclose(project_piezo_to_point_group(projected, rotations), projected, atol=1e-6)
